...
main(int argc, char **argv)
{
    ...
    pindexmatrix elements
            = load_indexmatrix("./Tests/Example2/elements.dat",3, 1);
    pindexmatrix elements2edges
            = load_indexmatrix("./Tests/Example2/elements2edges.dat",3, 1);
    int nBdry = 2;
    ...
    bdrytyp->vals[0] = 0;
    bdrytyp->vals[1] = 1;
    bdrylist[0] = load_indexmatrix("./Tests/Example2/Dirichlet.dat",2,1);
    bdrylist[1] = load_indexmatrix("./Tests/Example2/Neumann.dat",2,1);
    bdry2edgeslist[0] = load_indexvector("./Tests/Example2/Dirichlet2edges.dat");
    bdry2edgeslist[1] = load_indexvector("./Tests/Example2/Neumann2edges.dat");
    ...
    write_indexvector("./Tests/Example2/Neumann2edges_fine.dat",bdry2edgeslist[1]);
    ...
    write_realvector("./Tests/Example2/sol_fine.dat",sol);
